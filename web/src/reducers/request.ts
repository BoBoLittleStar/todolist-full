...
const add = createAsyncThunk<TodoResponse, string>(
  "add",
  async (task: string) => {
...
const edit = createAsyncThunk<TodoResponse, { id: string; task: string }>(
  "edit",
  async (payload: { id: string; task: string }) => {
...
const tick = createAsyncThunk<TodoResponse, string>(
  "tick",
  async (id: string) => {
...
const tickAll = createAsyncThunk<boolean, boolean>(
  "tickAll",
  async (tick: boolean) => {
...
const remove = createAsyncThunk<string, string>(
  "remove",
  async (id: string) => {
